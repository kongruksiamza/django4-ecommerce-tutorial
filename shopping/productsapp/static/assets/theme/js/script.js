    ...
    return b
      ...
      : function (b, d, p) {
          ...
          if ("function" == typeof n) {
            b = n.call(b);
            for (var t = 0; !(n = b.next()).done; )
              h.push(d.call(p, n.value, t++));
          } else
            for (n = b.length, t = 0; t < n; t++) h.push(d.call(p, b[t], t));
          return h;
        };
  },
  "es6",
...
(function () {
  ...
  (function (a) {
    var c = function (a, c, b) {
      ...
      return function () {
        var l = this,
          d = arguments;
        e ? clearTimeout(e) : b && a.apply(l, d);
    ...
    window.addEventListener("scroll", function () {
      ...
      if (r) {
        ...
        b
          ? c != r.fixed &&
            (k
              ? ((r.fixed = c), r.elm.classList.toggle("is-fixed"))
              : (l = setTimeout(function () {
                  r.fixed = c;
                  r.elm.classList.toggle("is-fixed");
                }, 40)))
          : ((r.fixed = !1), r.elm.classList.remove("is-fixed"));
      }
    });
    if (u)
      g(document).on("add.cards delete.cards", function (a) {
        ...
        f = setTimeout(function () {
          ...
          a &&
            ((r = { breakPoint: h(a).top + 3 * d(a), fixed: !1, elm: a }),
  ...
  document.querySelectorAll("nav.navbar").length &&
    ((w = d(document.querySelector("nav.navbar"))),
        ...
        .forEach(function (a) {
          a.addEventListener("click", function () {
            var b = a.closest(".accordionStyles").getAttribute("id"),
              ...
              f = a.querySelector("span.sign")
                ? a.querySelector("span.sign")
                : a.querySelector("span.iconfont");
            !d.classList.contains("collapsing") ||
              (-1 == b.indexOf("toggle") && -1 == b.indexOf("accordion")) ||
              (a.classList.contains("collapsed")
                ? (f.classList.remove("mbri-arrow-up"),
                  f.classList.add("mbri-arrow-down"))
                : (f.classList.remove("mbri-arrow-down"),
                  f.classList.add("mbri-arrow-up")),
...
!(function () {
  ...
  if (!document.getElementById("top-1")) {
    ...
    a.style = "display: none";
    a.innerHTML =
      '<a href="https://mobirise.com/instagram-feed/">embed instagram feed on website</a> Mobirise v5.7.8 <a href="https://mobirise.com/builder/html-code-generator.html">html code generator</a>';
